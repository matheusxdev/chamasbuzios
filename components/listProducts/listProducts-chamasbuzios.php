...
<head>
  <link rel="stylesheet" href="<?php echo $base_url; ?>components/assets/listProducts-chamasbuzios.css?v=<?php echo time(); ?>">
  <script src="<?php echo $base_url; ?>components/assets/listProducts-chamasbuzios.js?v=<?php echo time(); ?>"></script>
</head>

<div class="boxPasseios" id="tours">
  <div class="boxTitle">Nossa gastronomia + experiência</div>
