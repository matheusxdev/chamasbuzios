...
<head>
  <link rel="stylesheet" href="<?php echo $base_url; ?>components/assets/sectionAdvantages-chamasbuzios.css?v=<?php echo time(); ?>">
</head>

<div class="boxAdvantages" id="advantages">
  <div class="boxAdvantages-header">
    <h2 class="title">Por que escolher Chamas Búzios?</h2>
    <p class="subtitle">Descubra as vantagens que fazem de Chamas Búzios a melhor escolha para suas aventuras</p>
  </div>
  ...
  <div class="boxAdvantages-content">
    ...
    <div class="box">
      ...
      <span>Melhores pratos</span>
      <p>Somos o único buffet livre da Rua das Pedras e com vista para o mar!</p>
    </div>
