<?php
    ?>
      ...
      <div class="main">
        ...
        <div class="box">
          <h1 class="title">Seu pedido foi cancelado!</h1>
          <h2 class="subtitle">Você optou por cancelar o pedido, mas não se preocupe quando mudar de ideia só realizar o pedido novamente.</h2>
        </div>
