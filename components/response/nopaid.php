<?php
    ?>
      <head>
        ...
        <link rel="stylesheet" href="<?php echo $base_url; ?>components/assets/nopaid.css?v=<?php echo time(); ?>">
        <script src="<?php echo $base_url; ?>js/jquery-3.6.1.min.js"></script>
        <script src="<?php echo $base_url; ?>components/assets/nopaid.js?v=<?php echo time(); ?>"></script>
      ...
      <div class="main">
        ...
        <div class="box">
          <h1 class="title">Recebemos seu pedido da reserva, mas ainda não recebemos seu pagamento!</h1>
          <h2 class="subtitle">Realize seu pagamento para garantir sua reserva.</h2>
        </div>

        <div class="box boxInfo">
          <span class="info">Caso o pagamento do seu pedido não seja realizado dentro de 24 horas após a confirmação, o sistema realizará o cancelamento automaticamente.</span>
        </div>

        <div class="box boxCta">
          <a href="<?php echo $orderAtual["link"]; ?>"><button class="btnRedirectCheckout"><div class="icon"><i class="fa-regular fa-circle-check"></i></div><span>Pagar agora</span></button></a>
        </div>
      </div>
    <?php
?>