<?php
    ?>
      ...
      <div class="main">
        ...
        <div class="box">
          <h1 class="title">Solicite o cancelamento do pedido</h1>
          <h2 class="subtitle">Você optou por cancelar o pedido, mas parece que você já efetuou o pagamento. Por motivos de segurança, entre em contato e solicite o cancelamento ao atendente!</h2>
        </div>
